...
@DisplayName("Exception sinifləri testi")
class ExceptionTest {

    @Test
    @DisplayName("ResourceNotFoundException - resurs, sahə, dəyər ilə")
    ...
    @Test
    @DisplayName("ConflictException - resurs, sahə, dəyər ilə")
    ...
    @Test
    @DisplayName("BadRequestException - sahə və səbəb ilə")
    void badRequest_withFieldAndReason() {
        BadRequestException ex = new BadRequestException("email", "etibarlı deyil");

        assertThat(ex.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
        assertThat(ex.getMessage()).contains("email").contains("etibarlı deyil");
    }
